...
module.exports = {
    ...
    getSubAdmin: async (req, res) => {
        try {
            ...
            const subAdmin = await User.find({
                access_type: 'S'
            });
    ...
    createSubAdmin: async (req, res) => {
        try {
            ...
            console.log("New Sub-admin Create Request", params);
    ...
    getSubAdminProfile: async id => {
        console.log('Admin Request for Sub-Admin Profile ::', id)
    ...
    updateStatus: async function (req, res) {
        if(req.admin2factor){
            ...
            console.log("Sub-admin status update", params);
    ...
    withdrawCoin: async function (req, res) {
        ...
        if(req.admin2factor){
            ...
            console.log("Withdraw Coin To Sub-Admin", params);
